...
function qe(r, e, t, i = "brackets") {
  ...
  return r === "get" && Object.keys(t).length && (h3.search = M.stringify((0, import_deepmerge.default)(M.parse(h3.search, { ignoreQueryPrefix: true }), t), { encodeValuesOnly: true, arrayFormat: i }), t = {}), [[n ? `${h3.protocol}//${h3.host}` : "", a ? h3.pathname : "", c ? h3.pathname.substring(1) : "", d ? h3.search : "", m ? h3.hash : ""].join(""), t];
}
function I(r) {
...
var z = { created() {
  ...
  let e = this.$options.remember.key instanceof Function ? this.$options.remember.key.call(this) : this.$options.remember.key, t = jr.restore(e), n = this.$options.remember.data.filter((o2) => !(this[o2] !== null && typeof this[o2] == "object" && this[o2].__rememberable === false)), s2 = (o2) => this[o2] !== null && typeof this[o2] == "object" && typeof this[o2].__remember == "function" && typeof this[o2].__restore == "function";
  n.forEach((o2) => {
    this[o2] !== void 0 && t !== void 0 && t[o2] !== void 0 && (s2(o2) ? this[o2].__restore(t[o2]) : this[o2] = t[o2]), this.$watch(o2, () => {
      jr.remember(n.reduce((l, u2) => ({ ...l, [u2]: (0, import_lodash.default)(s2(u2) ? this[u2].__remember() : this[u2]) }), {}), e);
    }, { immediate: true, deep: true });
  });
} };
var j2 = z;
function C2(e, t) {
  let n = typeof e == "string" ? e : null, s2 = (typeof e == "string" ? t : e) ?? {}, o2 = n ? jr.restore(n) : null, l = typeof s2 == "function" ? (0, import_lodash2.default)(s2()) : (0, import_lodash2.default)(s2), u2 = null, f2 = null, m = (r) => r, y2 = reactive({ ...o2 ? o2.data : (0, import_lodash2.default)(l), isDirty: false, errors: o2 ? o2.errors : {}, hasErrors: false, processing: false, progress: null, wasSuccessful: false, recentlySuccessful: false, data() {
    ...
    r === "delete" ? jr.delete(i, { ...v, data: c }) : jr[r](i, c, v);
  }, get(r, i) {
    this.submit("get", r, i);
  }, post(r, i) {
  ...
  return watch(y2, (r) => {
    y2.isDirty = !(0, import_lodash3.default)(y2.data(), l), n && jr.remember((0, import_lodash2.default)(r.__remember()), n);
...
var oe2 = defineComponent({ name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: (e) => e }, onHeadUpdate: { type: Function, required: false, default: () => () => {
  ...
  return w2 = Fe(l, s2, o2), l || (jr.init({ initialPage: e, resolveComponent: n, swapComponent: async (u2) => {
    g2.value = markRaw(u2.component), h2.value = u2.page, k2.value = u2.preserveState ? k2.value : Date.now();
  } }), jr.on("navigate", () => w2.forceUpdate())), () => {
    if (g2.value) {
...
var N2 = oe2;
var V2 = { install(e) {
  jr.form = C2, Object.defineProperty(e.config.globalProperties, "$inertia", { get: () => jr }), Object.defineProperty(e.config.globalProperties, "$page", { get: () => h2.value }), Object.defineProperty(e.config.globalProperties, "$headManager", { get: () => w2 }), e.mixin(j2);
} };
function ne2() {
...
async function L2({ id: e = "app", resolve: t, setup: n, title: s2, progress: o2 = {}, page: l, render: u2 }) {
  let f2 = typeof window > "u", m = f2 ? null : document.getElementById(e), y2 = l || JSON.parse(m.dataset.page), r = (c) => Promise.resolve(t(c)).then((v) => v.default || v), i = [], a = await Promise.all([r(y2.component), jr.decryptHistory().catch(() => {
  })]).then(([c]) => n({ el: m, App: N2, props: { initialPage: y2, initialComponent: c, resolveComponent: r, titleCallback: s2, onHeadUpdate: f2 ? (v) => i = v : null }, plugin: V2 }));
  if (!f2 && o2 && He(o2), f2) {
...
var be2 = defineComponent({ name: "Link", props: { as: { type: String, default: "a" }, data: { type: Object, default: () => ({}) }, href: { type: String, required: true }, method: { type: String, default: "get" }, replace: { type: Boolean, default: false }, preserveScroll: { type: Boolean, default: false }, preserveState: { type: Boolean, default: null }, only: { type: Array, default: () => [] }, except: { type: Array, default: () => [] }, headers: { type: Object, default: () => ({}) }, queryStringArrayFormat: { type: String, default: "brackets" }, async: { type: Boolean, default: false }, prefetch: { type: [Boolean, String, Array], default: false }, cacheFor: { type: [Number, String, Array], default: 0 }, onStart: { type: Function, default: (e) => {
  ...
  let f2 = e.method.toLowerCase(), m = f2 !== "get" ? "button" : e.as.toLowerCase(), y2 = computed(() => qe(f2, e.href || "", e.data, e.queryStringArrayFormat)), r = computed(() => y2.value[0]), i = computed(() => y2.value[1]), a = computed(() => ({ a: { href: r.value }, button: { type: "button" } })), c = { data: i.value, method: f2, replace: e.replace, preserveScroll: e.preserveScroll, preserveState: e.preserveState ?? f2 !== "get", only: e.only, except: e.except, headers: e.headers, async: e.async }, v = { ...c, onCancelToken: e.onCancelToken, onBefore: e.onBefore, onStart: (d) => {
    ...
    jr.prefetch(r.value, c, { cacheFor: u2 });
  }, T2 = { onClick: (d) => {
    Ne(d) && (d.preventDefault(), jr.visit(r.value, v));
  } }, J2 = { onMouseenter: () => {
    o2.value = setTimeout(() => {
      p2();
    }, 75);
    ...
    Ne(d) && (d.preventDefault(), p2());
  }, onMouseup: (d) => {
    d.preventDefault(), jr.visit(r.value, v);
  }, onClick: (d) => {
    Ne(d) && d.preventDefault();
  } };
...
function B2(e, t = {}, n = { keepAlive: false, autoStart: true }) {
  let { stop: s2, start: o2 } = jr.poll(e, t, { ...n, autoStart: false });
  return onMounted(() => {
    (n.autoStart ?? true) && o2();
  }), onUnmounted(() => {
    s2();
...
function q2(e = {}) {
  let t = ref(false), n = ref(null), s2 = ref(false), o2 = typeof window > "u" ? null : jr.getCached(window.location.pathname, e), l = typeof window > "u" ? null : jr.getPrefetching(window.location.pathname, e);
  n.value = (o2 == null ? void 0 : o2.staleTimestamp) || null, t.value = l !== null, s2.value = o2 !== null;
  let u2, f2;
  return onMounted(() => {
    f2 = jr.on("prefetching", (m) => {
      m.detail.visit.url.pathname === window.location.pathname && (t.value = true);
    }), u2 = jr.on("prefetched", (m) => {
      m.detail.visit.url.pathname === window.location.pathname && (t.value = false, s2.value = true);
    });
  }), onUnmounted(() => {
    u2(), f2();
  }), { lastUpdatedAt: n, isPrefetching: t, isPrefetched: s2, flush: () => jr.flush(window.location.pathname, e) };
}
function W2(e, t) {
  if (typeof e == "object" && e !== null && e.__rememberable === false) return e;
  let n = jr.restore(t), s2 = isReactive(e) ? reactive : ref, o2 = typeof e.__remember == "function" && typeof e.__restore == "function", l = s2(n === void 0 ? e : o2 ? e.__restore(n) : n);
  return watch(l, (u2) => {
    jr.remember((0, import_lodash4.default)(o2 ? e.__remember() : u2), t);
